...
namespace SistemaDeConvocacoes.Infra.Migrations
{
    ...
    [Migration("20200726143938_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Cargos", b =>
                {
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Clientes", b =>
                {
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Convocacoes", b =>
                {
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Convocados", b =>
                {
                    b.Property<Guid>("ConvocadoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Documentos", b =>
                {
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Processos", b =>
                {
                    b.Property<Guid>("ProcessoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Telefone", b =>
                {
                    ...
                    b.Property<Guid?>("PessoaIdPessoaId")
                        .HasColumnName("PessoaId_PessoaId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("TelefoneId");

                    b.HasIndex("PessoaIdPessoaId");

                    b.ToTable("Telefone");
                });

            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Telefones", b =>
                {
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Cargos", b =>
                {
                    b.HasOne("SistemaDeConvocacoes.Domain.Entities.Processos", "Processo")
                        .WithMany("Cargos")
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Processos", b =>
                {
                    b.HasOne("SistemaDeConvocacoes.Domain.Entities.Clientes", "Cliente")
                        .WithMany("Processos")
            ...
            modelBuilder.Entity("SistemaDeConvocacoes.Domain.Entities.Telefone", b =>
                {
                    b.HasOne("SistemaDeConvocacoes.Domain.Entities.Pessoa", "PessoaIdPessoa")
                        .WithMany("TelefoneNavigation")
                        .HasForeignKey("PessoaIdPessoaId")
